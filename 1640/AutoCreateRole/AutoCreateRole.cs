...
public class AutoCreateRole : IAutoCreateRole
{
    ...
    public void CreateRole()
    {
        ...
        _userManager.AddToRoleAsync(manager, Constraintt.ManagerRole).GetAwaiter().GetResult();
    }
}